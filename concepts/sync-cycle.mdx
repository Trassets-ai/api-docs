...
description: "Understand the upstream sync behind the Data API: TRUNCATE+Reload semantics, last_sync_at, and what GET /changes actually detects."
---

The Data API is a read-only interface over data that is synced in from an
