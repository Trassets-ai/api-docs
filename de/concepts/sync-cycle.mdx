...
Daten fließen durch drei Stufen: **Data Lakehouse → Cloud-Speicher → OLTP-Datenbank**. Die API hat zur Laufzeit keine direkte Verbindung zu Databricks — sie liest ausschließlich aus RDS. Die zugrunde liegenden Databricks-Jobs heißen `parquet_to_s3` und `ingest_parquet_to_rds`.
