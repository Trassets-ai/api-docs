...
<ResponseField name="account_number" type="string">
  Sachkonto, auf das sich die Abweichung bezieht. Entspricht
  `Accounting.accounts.account_number` — trotz ähnlich klingendem Namen nicht dasselbe wie
...
<ResponseField name="debit_type" type="object">
  ...
  <Expandable title="properties">
    <ResponseField name="code" type="integer">
      Sollart-Code. Kein Kontenbezug — nicht zu verwechseln mit dem `account_number`-Feld
      dieser selben Tabelle oder mit `contract_debit_diffs.account_number`.
    </ResponseField>
...
<ResponseField name="deadline_lead_time" type="integer">
  Vorlaufzeit in Monaten vor `option_deadline`, ab der Erinnerungen ausgelöst werden.
</ResponseField>
