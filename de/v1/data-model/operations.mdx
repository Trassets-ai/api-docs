...
<ResponseField name="cost_center_id" type="string">
  Kostenstelle, gegen die die Meldung gebucht wird.
</ResponseField>

<ResponseField name="cost_center_id_name" type="string">
  Kostenstellen-ID und -Name, vorab zu einem Anzeige-String kombiniert (z. B. für Power BI).
  Kein Verknüpfungsschlüssel.
</ResponseField>
...
<ResponseField name="Status" type="string">
  Aktueller Status der Meldung. Im Response großgeschrieben — kein Tippfehler in dieser
  Doku, das ist der live geltende Feldname.
</ResponseField>
...
<ResponseField name="comment" type="string">
  Statuskommentar zum Projekt.
</ResponseField>

<ResponseField name="comment_1" type="string">
  Freitext-Hinweis. Nicht zusammengeführt mit `comment`/`comment_2`/`comment_3` — vier
  getrennte Felder.
</ResponseField>

<ResponseField name="comment_2" type="string">
  Freitext-Hinweis, siehe `comment_1`.
</ResponseField>
