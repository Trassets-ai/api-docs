...
<ResponseField name="hierarchy" type="string[]">
  Wo das Projekt im Kontenbaum der Buchhaltung "aufgehängt" ist, als geordnete Liste von
  grob nach fein (z. B. `["4", "4.2", "4.2.1"]` — oberste Kostenkategorie, Unterkategorie,
  konkretes Konto). Wie ein Ordnerpfad, nur numerisch statt benannt. Leere, tiefere
  Ebenen werden weggelassen.
</ResponseField>
...
<ResponseField name="is_project_management_flag" type="string">
  Klassifizierungs-Flag zur Projektleitung (`"0"`/`"1"`).
</ResponseField>
