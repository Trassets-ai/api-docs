...
<Note>
  ...
  also mehr als eine Zeile pro Person liefern. `tenancy_id` ist außerdem das Feld, auf das
  sich [`Contracts.contract_debits` und `Contracts.contract_ends`](/de/v1/data-model/contracts)
  beziehen.
</Note>
