...
description: "Feldreferenz für die v1-Stakeholder-Tabelle tenants, inklusive ihrer Mietvertrags-Datumsfelder und der noch nicht zu einem Array zusammengefassten Telefon-Spalten."
---

Die v1-Stakeholder-Domäne umfasst aktuell eine Tabelle: `tenants`.

<Note>
  `tenants` folgt noch nicht vollständig den
  [Response-Shape-Konventionen](/de/v1/response-shape-conventions) — die durchnummerierten
  Spalten `phone_1`/`phone_2`/`phone_3` wurden noch nicht zu einem Array zusammengefasst.
  Trotzdem hier dokumentiert, da der Rest der Tabelle stabil ist; diese drei Felder können
  sich in einer künftigen Revision noch ändern.
</Note>
...
<ResponseField name="phone_3" type="string">
  Zusätzliche Telefonnummer. Diese drei durchnummerierten Spalten wurden noch nicht zu
  einem Array zusammengefasst — siehe Hinweis oben.
</ResponseField>
