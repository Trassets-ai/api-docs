...
<Note>
  ...
  `Contracts.index_rent`](/de/v1/data-model/contracts) beziehen — hier und bei
  `contract_ends`/`index_rent` ein Integer, bei `contract_debits` dagegen ein String, dort also
  vor dem Join casten.
</Note>
