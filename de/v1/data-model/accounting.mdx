...
<ResponseField name="category" type="string">
  Reporting-Kategorie aus dem Kontenmapping (z. B. Einnahmen, Ausgaben, Abschreibungen).
</ResponseField>

<ResponseField name="group" type="string">
  Klassifizierung ergebniswirksam vs. bilanzneutral aus dem Kontenmapping.
</ResponseField>
...
<Note>
  `category`, `group` und `nr` sind `null` bei Konten, die noch auf der älteren
  Kontenbereichs-Klassifizierung laufen — diese liefert diese drei Felder nicht.
</Note>
...
<ResponseField name="account_balance_type" type="object">
  ...
  <Expandable title="properties">
    ...
    <ResponseField name="label" type="string">
      Lesbare Bezeichnung zum Code (z. B. "Aufwandskonto", "Ertragskonto").
    </ResponseField>
  </Expandable>
</ResponseField>
