...
nicht in `accounts.account_id`. Sollstellungen (`contract_debits`, `contract_debit_diffs`)
referenzieren das Sachkonto, auf das sie buchen, über `ledger_id` — ebenfalls gegen
