...
description: "Die Contracts-Domäne der Data API mit Mietsollstellungen, Sollstellungsabweichungen, Dienstleistungsverträgen und Vertragsenden — mit echten Feldnamen und Verknüpfungsschlüsseln."
---
...
<ResponseField name="contract_end_id" type="string">
  Interner Hash, der diesen konkreten Vertragsende-/Options-Datensatz identifiziert. Nicht
  langfristig stabil — ändert sich, wenn die zugrunde liegende Optionsfrist oder das
  Vertragsende verschoben wird. Nicht als dauerhafte externe Referenz gedacht.
</ResponseField>
