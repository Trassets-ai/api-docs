---
title: "Data API: Real-Estate Data for Developers"
description: "The Data API provides property, contract, accounting, and operations data for developers building property management integrations and analytics."
sidebarTitle: "Overview"
---

The Data API delivers structured, machine-readable real estate data to developers and data engineers. It exposes property information, rental contracts, financial bookings, fixed assets, and maintenance operations through a single REST interface so you can build dashboards, sync pipelines, and reporting tools without maintaining multiple integrations.
