...
<ResponseField name="cost_center_id" type="string">
  Cost centre the report is booked against.
</ResponseField>
...
<ResponseField name="Status" type="string">
  Current status of the report. Capitalized in the response — not a typo in this
  documentation, that's the live field name.
</ResponseField>
...
<ResponseField name="hierarchy" type="string[]">
  The project's position in a cost-breakdown hierarchy, as an ordered list of levels. Empty
  levels are omitted.
</ResponseField>
...
<ResponseField name="comment" type="string">
  Status comment on the project.
</ResponseField>

<ResponseField name="comment_1" type="string">
  Free-text note. Not merged with `comment`/`comment_2`/`comment_3` — four separate fields.
</ResponseField>

<ResponseField name="comment_2" type="string">
  Free-text note, see `comment_1`.
</ResponseField>
