...
<ResponseField name="afa_validity" type="string">
  Validity date of the depreciation-rate configuration applied to this asset. In practice,
  always identical to `afa_period.start` — an ETL duplicate, not an independent signal.
  Scheduled for removal in a future API version.
</ResponseField>
