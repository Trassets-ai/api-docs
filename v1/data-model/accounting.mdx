---
title: "v1 Accounting Data Model: Booking Header, Positions, and Budgets"
sidebarTitle: "Accounting"
description: "Field-level reference for the v1 Accounting tables booking_header, booking_positions, and budgets, reshaped with period, amount, and amount_per_sqm objects."
---

The v1 Accounting domain currently covers three tables: `booking_header`,
`booking_positions`, and `budgets`. All three follow the [response shape
