...
description: "Explore the five accounting tables in the Data API covering accounts, booking headers, booking positions, budgets, and account-range mappings, with real field names."
---
