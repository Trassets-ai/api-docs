...
description: "Explore the six data domains of the Data API and how entities relate through property_id, floor_area_id, and other join keys."
---

The Data API organises real-estate data into six domains, matching the category
