...
description: "Explore the Contracts domain in the Data API, covering rental debits, debit diffs, service contracts, and contract ends with real field names and join keys."
---
...
<ResponseField name="contract_end_id" type="string">
  Internal hash identifying this specific lease-end/option record. Not stable long-term —
  it changes if the underlying option deadline or contract end date is shifted. Not
  intended as a persistent external reference.
</ResponseField>
